SQL.IO = function(owner) {
    ...
    OZ.Event.add(this.dom.d2rqmapping, "click", this.d2rqmapping.bind(this));
    OZ.Event.add(this.dom.r2rmlmapping, "click", this.r2rmlmapping.bind(this));
    OZ.Event.add(this.dom.dumpedturtle, "click", this.dumpedturtle.bind(this));
    OZ.Event.add(this.dom.uploadontology, "click", this.uploadontology.bind(this));
    OZ.Event.add(this.dom.namespaces, "click", this.namespaces.bind(this));
    OZ.Event.add(this.dom.tablejoin, "click", this.tablejoin.bind(this));
...
SQL.IO.prototype.click = function() { /* open io dialog */
    ...
    */
    $.getScript('/ajax/er/save_xml_dialog/' + this.owner.work_id);
...
SQL.IO.prototype.d2rqmapping = function() {
    window.open("/d2rq_mapping/" + this.owner.work_id + ".ttl", "d2rqmapping", "width=700,height=700,scrollbars=yes");
}

SQL.IO.prototype.r2rmlmapping = function() {
    window.open("/r2rml_mapping/" + this.owner.work_id + ".ttl", "r2rmlmapping", "width=700,height=700,scrollbars=yes");
}

SQL.IO.prototype.dumpedturtle = function() {
    window.open("/turtle/" + this.owner.work_id + "/preview", "rdf", "width=700,height=700,scrollbars=yes");
}

SQL.IO.prototype.uploadontology = function() {
    $("#upload-ontology").modal();
}

SQL.IO.prototype.namespaces = function() {
    window.open("/er/" + this.owner.work_id + "/namespace/", "namespaces", "width=1000,height=700,scrollbars=yes");
}

SQL.IO.prototype.tablejoin = function() {
    $("#modal-join").modal();
}
...
SQL.IO.prototype.serversave = function(e, keyword) {
    ...
    */
    ...
    var url = "/works/" + name + "/er_data";
    $.post(url, {xmldata: xml}, this.saveresponse, "xml");
}
...
SQL.IO.prototype.serverload = function(e, keyword) {
    ...
    var url = "/ajax/er/server_load/" + keyword;
    this.owner.window.showThrobber();
    this.name = name;
