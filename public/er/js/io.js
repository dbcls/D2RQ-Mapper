...
SQL.IO.prototype.d2rqmapping = function() {
    console.log("d2rqmapping");
    window.open("/iswc2-mysql1-d2rq-mapping.ttl", "d2rqmapping", "width=700,height=700,scrollbars=yes");
}

SQL.IO.prototype.r2rmlmapping = function() {
    console.log("r2rmlmapping");
    window.open("/iswc2-mysql1-r2rml-mapping.ttl", "r2rmlmapping", "width=700,height=700,scrollbars=yes");
}

SQL.IO.prototype.dumpedturtle = function() {
    console.log("dumpedturtle");
    window.open("/iswc2-mysql1.ttl", "rdf", "width=700,height=700,scrollbars=yes");
}
...
SQL.IO.prototype.serverload = function(e, keyword) {
    ...
    var url = "/ajax/sqldesigner/server_load/" + keyword;
    this.owner.window.showThrobber();
    this.name = name;
